...
win:
	i686-w64-mingw32-gcc main.c -Ofast -I inc -L inc -lglfw3dll -lm -o release/$(name)_windows.exe
...
dbg:
	cc main.c -I inc -DGL_DEBUG -fsanitize=leak -fsanitize=undefined -fsanitize=address -ggdb3 -lglfw -lm -o release/$(name)_dbg
	release/$(name)_dbg
